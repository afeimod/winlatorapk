...
public class ExtraFeatures {
    public static class AndroidShortcut{
        //包名前缀动态添加吧
...
//                    persistableBundle.putInt(CONTAINER_ID, xdgLink.guestCont.mId);
...
//                            .setExtras(persistableBundle)
                    ...
                    .setActivity(new ComponentName(a.getPackageName(), a.getPackageName() + ".MainActivity")) //设置目标activity
                    .build();
...
//            shortcutManager.setDynamicShortcuts(shortcutInfoList);
        ...
        public static void handleIfStartFromScreenShortcut(MainActivity a) {
            ...
            String shortcutPath = intent.getStringExtra(a.getPackageName() + ExtraFeatures.AndroidShortcut.DESKTOP_FILE_ABSOLUTE_PATH);
            if(shortcutPath!=null){
                int contId = intent.getIntExtra(a.getPackageName() + ExtraFeatures.AndroidShortcut.CONTAINER_ID, 0);
...
//                            .setExtras(info.getExtras())
                    ...
                    if (shortcut.icon != null)
                        ...
                        Log.d("", "setDynamicShortcuts: 没有图标："+shortcut.iconFile+"/"+shortcut.icon + ".png");
                    }
                    nonNullList.remove(i);
